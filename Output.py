...
class Output:
    ...
    lane1 = Lane("ID1", 30, (110, 70), "departing")
    lane2 = Lane("ID2", 30, (110, 70), "receiving")
    lane3 = Lane("ID3", 30, (80, 100), "departing")
    lane4 = Lane("ID4", 30, (80, 100), "receiving")
    lane5 = Lane("ID5", 30, (50, 70), "departing")
    lane6 = Lane("ID6", 30, (50, 70), "receiving")
    lane7 = Lane("ID7", 30, (80, 40), "departing")
    lane8 = Lane("ID8", 30, (80, 40), "receiving")
    ...
    intersection1 = Intersection("ID", "name", (80, 70), 4, (leg1, leg2, leg3, leg4))
